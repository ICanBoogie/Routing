...
final class RespondEventTest extends TestCase
{
	...
	{
		get_events()->attach(function (Route\RespondEvent $event, Route $target) use(&$used): void {
			$used = true;
		});

		new Route\RespondEvent($this->route, $this->request);
