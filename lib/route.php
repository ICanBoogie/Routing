...
class Route extends Object
{
	 ...
	 * @return Response
	 */
	public function __invoke(Request $request) // TODO-20121128: shouldn't this be moved to the dispatcher ?
	{
		...
		if (isset($this->controller))
		{
			...
			$request->route = $this; // FIXME-20120828: isn't this supposed to be set by the dispatcher ?
